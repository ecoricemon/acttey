...
macro_rules! define_vertex {
    ([$ptype:ty; $pdim:expr], [$ctype:ty; $cdim:expr], [$ntype:ty; $ndim:expr]) => {
        pub type Position = acttey_math::prelude::Vector<$ptype, $pdim>;
        pub type Color = acttey_math::prelude::Vector<$ctype, $cdim>;
        pub type Normal = acttey_math::prelude::Vector<$ntype, $ndim>;
        ...
        impl Vertex {
            ...
            pub fn layout(attributes: &[wgpu::VertexAttribute; 3]) -> wgpu::VertexBufferLayout {
