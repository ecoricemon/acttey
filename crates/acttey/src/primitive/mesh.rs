use crate::{
    ...
    util::{key::AnObjectKey, AsMultiBytes},
};
...
/// [`ObjectKey`] for [`Mesh`].
pub type MeshKey = AnObjectKey<Mesh>;

/// [`ObjectKey`] for [`Geometry`].
pub type GeometryKey = AnObjectKey<Geometry>;

/// [`ObjectKey`] for [`Material`].
pub type MaterialKey = AnObjectKey<Material>;
...
pub(crate) struct MeshPrimitive {
    pub(crate) geo_key: GeometryKey,
    pub(crate) mat_key: MaterialKey,
